  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert('¡Inicio de sesión exitoso! Bienvenido a GameTracker')
      ...
      <form className="form needs-validation" onSubmit={handleSubmit}>
        ...
        <div className="form__links">
          <p>
            ...
            <Link to="/registrar" style={{ fontWeight: '600' }}>
              Crear cuenta nueva
            </Link>
          </p>
          <p>
        ...
        <div style={{ marginTop: '20px', padding: '15px', background: 'rgba(255,255,255,0.05)', borderRadius: '8px', textAlign: 'center' }}>
          <p style={{ fontSize: '12px', color: '#888', margin: 0 }}>
            ...
            <Link to="/terminos" style={{ color: '#4a90e2' }}>Términos de servicio</Link>
            {' '}y{' '}
            <Link to="/privacidad" style={{ color: '#4a90e2' }}>Política de privacidad</Link>
          </p>
        </div>
      </form>
    </section>
